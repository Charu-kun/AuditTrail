...
Public Class panelForm1
    ...
    '    MsgBox("Info" & vbCrLf & "here pls", MsgBoxStyle.Information, "Help")
    'End Sub
    ...
    'Private Sub Tbx_ClientName_TextChanged(sender As Object, e As EventArgs) Handles Tbx_ClientName.TextChanged

    'End Sub

    'Private Sub Tbx_Budget_TextChanged(sender As Object, e As EventArgs) Handles Tbx_Budget.TextChanged
